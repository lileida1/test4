...
public class HeartLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private void findViewById(Context context) {
        ...
        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.icon_like2);
    ...
    public void addFavor() {
        ...
        heartView.setAdjustViewBounds(true);
        heartView.setMaxHeight(10);
        heartView.setMaxWidth(10);
